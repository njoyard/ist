define([
	'ist',
	'ist!builtins/include/include',
	'text!builtins/include/include.ist',
	'text!builtins/include/includetext.ist',
	'text!builtins/include/includeinvalid.ist',
	
	// These ones are only preloaded
	'builtins/include/included_invalid',
	'ist!builtins/include/included_ist',
	'text!builtins/include/included_text.ist',
	'builtins/include/included_string',
	'builtins/include/included_compiled'
	...
	return function() {
		...
		it("should fail to render templates with invalid includes", function() {
			expect( function() { ist(textIncludeInvalid).render(); } ).toThrow( "Invalid included template 'builtins/include/included_invalid' in '<unknown>' on line 1" );
		});
	};
});
