...
(function (global) {
    ...
    var parser_parser = function (helpers) {
            var pegjsParser;
    ...
    var parser_preprocessor = function () {
    ...
    var main = function (Template, directives, Context, pegjsParser, preprocess, pluginify, misc) {
            ...
            return ist;
        }(components_template, components_directives, components_context, parser_parser, parser_preprocessor, util_amdplugin, util_misc);
    if (isAMD || isNode) {
        define('ist', [], function () {
            return main;
        });
